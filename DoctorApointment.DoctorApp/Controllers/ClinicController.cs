...
namespace DoctorApointment.DoctorApp.Controllers
{
    public class ClinicController : BaseController
    {
        ...
        private readonly string NAMESAPACE = "DoctorApointment.DoctorApp.Controllers.Clinic";
        ...
        {
            var clinic = await _clinicApiClient.GetById(request.Id);
            ...
            ViewBag.Img = clinic.IsSuccessed == true ? clinic.Data.ImgLogo.ToString() : "";
            ViewBag.Imgs = clinic.IsSuccessed == true ? clinic.Data.Images : null;
