...
namespace DoctorApointment.DoctorApp.Controllers
{
    public class HomeController : BaseController
    {
        ...
        private readonly string NAMESAPACE = "DoctorApointment.DoctorApp.Controllers.Home";
