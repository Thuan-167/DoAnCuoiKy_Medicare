...
namespace DoctorApointment.Application.Catalog.MasterData
{
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
        ...
        public async Task<ApiResult<bool>> UpdateMainMenu(MainMenuUpdateRequest request)
        {
            ...
            MainMenu.Type = request.Type == "0" ? "MenuHeader" : request.Type == "2" ? "MenuPanner" : request.Type == "1" ? "MenuHeaderDrop" : request.Type == "3" ? "Topic" : request.Type == "4" ? "Category" : "Categoryfeature";
            if (request.Image != null)
            {
